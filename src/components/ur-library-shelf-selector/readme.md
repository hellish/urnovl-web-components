...
| `createNewShelfSubtitleText` | `create-new-shelf-subtitle-text` |             | `string`              | `'Create a shelf and organize your favorite stories in your Library.'` |
...
| `createShelfEvent` |             | `CustomEvent<{ shelfName: string; isPublic: boolean; }>` |
