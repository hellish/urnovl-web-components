import{k as g}from"./entry-preview-BcHUnPw7.js";import"./ur-linear-progress-CMdnFZf_.js";import"./index-DrFu-skq.js";import"./chunk-L4EGOTBX-2Jzo53v8.js";import"./index-HG5WCs1g.js";const d=s=>g` <ur-linear-progress max="${s.max}" value="${s.value}"></ur-linear-progress> `,D={title:"Core/Linear Progress",render:d,argTypes:{max:{control:"number",description:"The maximum value for the progress bar"},value:{control:"number",description:"The current value for the progress bar. If omitted, the progress bar will be indeterminate."}}},r={args:{max:1},render:()=>g` <ur-linear-progress max="1"></ur-linear-progress> `},e={args:{max:1,value:.5}},a={args:{max:100,value:100}};var o,t,n;r.parameters={...r.parameters,docs:{...(o=r.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    max: 1
  },
