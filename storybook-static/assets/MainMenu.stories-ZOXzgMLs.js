import{k as g}from"./entry-preview-BcHUnPw7.js";import"./ur-list-BtEPwSfP.js";import"./ur-list-item-OhVirBOP.js";import"./ur-tooltip-DuFJ5Hb5.js";import"./ur-button-icon-BechBhvu.js";import"./ur-logo-DDg8Fqu8.js";import"./ur-button-Cj914QN4.js";import"./ur-menu-profile-DDdPeBc0.js";import{s as S,g as x}from"./chunk-L4EGOTBX-2Jzo53v8.js";import{d as E,H as P,c as i,h as e,a as D}from"./index-DddAbXmr.js";import"./ur-avatar-LWOBhbU6.js";import"./index-DrFu-skq.js";import"./class-map-CDMw4-pN.js";import"./query-assigned-elements-BInJlOXT.js";import"./get-7S0C3xNv.js";import"./anchor--mD29Q5y.js";import"./if-defined-CL77Dv0Z.js";import"./template-yncBVCyc.js";import"./index-BriiHZyV.js";import"./index-CIbCn1or.js";import"./watch-ByvFYHv8.js";import"./button-base-CWeRpzKK.js";import"./form-B80GgqR6.js";import"./index-DsS9OQyQ.js";import"./index-B-mBYDoO.js";const q=`:host {
    height: 100%;
    display: flex;
...
:host .notification-badge:empty {
    ...
    `;return g`
        <div class="menu-controls-wrapper" style="padding: 20px;">
            <div style="margin-bottom: 16px; display: flex; align-items: center; gap: 8px;">
                ...
                <button @click=${H} class="toggle-button" style=${u}>${n?"Close Menu":"Open Menu"}</button>

                <button @click=${$} style=${u}>-1 Badge</button>

                <button @click=${A} style=${u}>+1 Badge</button>

                <span class="badge-count" style="margin-left: 12px;"> Current Badge Count: ${r} </span>
            </div>
            ...
            >
                <ur-autosave-drawer
                    ...
                    @autosaveOpen=${o=>console.log("Open autosave:",o.detail)}
                    @autosaveDeleteRequest=${o=>console.log("Delete request:",o.detail)}
                    @autosaveDeleteConfirm=${o=>console.log("Delete confirm:",o.detail)}
                    @autosaveDeleteCancel=${o=>console.log("Delete cancel:",o.detail)}
                ></ur-autosave-drawer>
                ${t.loggedIn?g`
                          <ur-menu-profile
    ...
    `},pe={title:"urnovl/Business/Main Menu",render:t=>L(t),argTypes:{opened:{control:"boolean",description:"Determines whether the menu is expanded (open) or collapsed (closed)"},loggedIn:{control:"boolean",description:"Determines if the user is logged in"},userName:{control:"text",description:"Name of the logged-in user"},userRole:{control:"text",description:"Role of the logged-in user"},userAvatar:{control:"text",description:"URL of the user avatar"},badgeCount:{control:"number",description:"Number of notifications to display in the badge"},autosaves:{control:"array",description:"Array of autosaves to display in the drawer"},emptyMessage:{control:"text",description:"Message to display when the drawer is empty"},chapterText:{control:"text",description:"Text for the chapter label"},yesText:{control:"text",description:"Text for the yes button"},noText:{control:"text",description:"Text for the no button"},deleteConfirmMessage:{control:"text",description:"Text for the delete confirmation message"}},parameters:{actions:{handles:["menuToggleClick"]}}},s={args:{opened:!1,loggedIn:!1,userName:"Guest",userRole:"",userAvatar:"",badgeCount:0}},l={args:{opened:!0,loggedIn:!1,userName:"Guest",userRole:"",userAvatar:"",badgeCount:0}},c={args:{opened:!1,loggedIn:!0,userName:"Tasos Tsipos",userRole:"Author & Reader",userAvatar:"https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5",badgeCount:5}},d={args:{opened:!0,loggedIn:!0,userName:"Tasos Tsipidopoulakoglou",userRole:"Author & Reader",userAvatar:"https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5",badgeCount:10,autosaves:[{id:1,novl:{title:"My First Novel"},title:"The random chapter title",sequence:1,showOptions:!1},{id:2,novl:{title:"My Second Novel"},title:"Lone wolf",sequence:2,showOptions:!1}],emptyMessage:"You don't have anything saved in your drawer, yet!",chapterText:"Chapter",yesText:"Yes",noText:"No",deleteConfirmMessage:"Delete chapter?"}};var k,v,C;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    opened: false,
    loggedIn: false,
    userName: 'Guest',
...
}`,...(C=(v=s.parameters)==null?void 0:v.docs)==null?void 0:C.source}}};var b,y,w;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    opened: true,
    loggedIn: false,
    userName: 'Guest',
...
}`,...(U=(N=c.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};var R,M,O;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    opened: true,
    loggedIn: true,
...
}`,...(O=(M=d.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};const he=["Default","LoggedOutOpened","LoggedInClosed","LoggedInOpened"];export{s as Default,c as LoggedInClosed,d as LoggedInOpened,l as LoggedOutOpened,he as __namedExportsOrder,pe as default};
