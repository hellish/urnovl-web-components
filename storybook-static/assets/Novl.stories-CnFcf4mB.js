import{k as nr}from"./entry-preview-BcHUnPw7.js";import{N as r}from"./ur-novl-75f9MYLo.js";import"./index-DrFu-skq.js";import"./chunk-L4EGOTBX-2Jzo53v8.js";import"./index-CLClakx-.js";const cr=({novlTitle:u,novlCover:J,likes:K,views:M,showStats:Q,novlDescription:T,authorAvatar:X,authorName:Y,published:Z,price:rr,publisherName:er,publisherAvatar:sr,borderRadius:ar="8px",width:or,loading:tr=!1})=>nr`
    <style>
        ur-novl {
            --novl-width: ${or};
            --novl-border-radius: ${ar};
        }
    </style>
    <ur-novl
        author-name="${Y}"
        ...
        publisher-name="${er}"
        publisher-avatar="${sr}"
        loading=${tr}></ur-novl>`,mr={title:"Urnovl/Business/Novl",render:u=>cr(u)},e={args:r[0]},s={args:{...r[0],novlCover:null}},a={args:r[1]},o={args:r[2]},t={args:r[3]},n={args:r[4]},c={args:r[5]},i={args:{...r[6],width:"320px"}},d={args:{...r[7],width:"350px"}},p={args:{...r[7],novlCover:r[6].novlCover,width:"100%",borderRadius:"0"}},l={args:{...r[2],loading:!0,showStats:!0,width:"300px"}};var m,g,v;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: NOVLS[0]
...
}`,...(N=(h=s.parameters)==null?void 0:h.docs)==null?void 0:N.source}}};var L,$,O;a.parameters={...a.parameters,docs:{...(L=a.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: NOVLS[1]
}`,...(O=($=a.parameters)==null?void 0:$.docs)==null?void 0:O.source}}};var w,V,W;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: NOVLS[2]
...
}`,...(I=(H=l.parameters)==null?void 0:H.docs)==null?void 0:I.source}}};const gr=["Default","BrokenCover","NoStats","SmallDescription","WithPrice","WithPublisher","Full","BiggerWidth","FullWithBiggerWidth","NoBorderRadius","LoadingData"];export{i as BiggerWidth,s as BrokenCover,e as Default,c as Full,d as FullWithBiggerWidth,l as LoadingData,p as NoBorderRadius,a as NoStats,o as SmallDescription,t as WithPrice,n as WithPublisher,gr as __namedExportsOrder,mr as default};
