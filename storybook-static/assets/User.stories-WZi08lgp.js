...
`,se=class extends J{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.userFollowClicked=X(this,"userFollowClicked",7),this.userTitle="User title",this.userCover=void 0,this.userCoverFallback=Y,this.followers=0,this.showStats=!0,this.userDescription=void 0}render(){return e(Z,{key:"d91e23af9629791c87d439dcaa1d6ef2f39292cb"},e("div",{key:"9e43b2109091334f87ceeac2964b9e2a60212619",class:"user"},e("section",{key:"836e70ae0007ffdbafe46c0ef72469665a171516",class:"cover",style:{backgroundImage:this.userCover?`url(${this.userCover})`:`url(${this.userCoverFallback})`}}),e("section",{key:"e497660b1b1d3f73abeaba95facb29069bf6a4e4",class:"info"},e("div",{key:"2419ff4b222062c711612319890ab78cec58c153",class:"title"},this.userTitle),this.showStats&&e("div",{key:"a8b251846680fd32e69b0f1cf1259b7d554f9b32",class:"stats"},e("div",{key:"2af7583ac00bc5d4f898744bc1449a4c8fd392a6",class:"followers"},e("div",{key:"afba968647767942f4739db711a2d347359f2a0a"},e("b",{key:"6f4600b1e79a7a44e27d7ad32925abef85e46000"},this.followers)," Followers"))),e("div",{key:"a87b6feb4745f8dd3d253bcdfb0e647d0da04cd8",class:"description"},this.userDescription),e("div",{key:"b6d39d7771d1b6c5ca834ac6037e6365d8302d87",class:"actions"},e("ur-button",{key:"c496ef2054a13d50809263aede5e4d4bedc6c47f",class:"follow",variant:"outlined",onClick:()=>this.userFollowClicked.emit()},"Follow")))))}static get style(){return ee}};G(se,[1,"ur-user",{userTitle:[1,"user-title"],userCover:[8,"user-cover"],userCoverFallback:[8,"user-cover-fallback"],followers:[2],showStats:[4,"show-stats"],userDescription:[8,"user-description"]}]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"UrUser",tagName:"ur-user",customElement:!0,members:[{kind:"field",name:"userTitle",type:"string",description:"",default:"'User title'"},{kind:"field",name:"userCover",type:"any",description:""},{kind:"field",name:"userCoverFallback",type:"any",description:"",default:"USER_COVER_FALLBACK"},{kind:"field",name:"followers",type:"number",description:"",default:"0"},{kind:"field",name:"showStats",type:"boolean",description:"",default:"true"},{kind:"field",name:"userDescription",type:"any",description:""}],events:[{kind:"event",name:"userFollowClicked",description:""}]}],exports:[{kind:"js",name:"UrUser",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}},{kind:"custom-element-definition",name:"ur-user",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}}]}]};q({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const re=({userTitle:u,userCover:W,followers:N,showStats:Q,userDescription:H,borderRadius:V="8px",width:j})=>K`
    <style>
        ur-user {
            --user-width: ${j};
