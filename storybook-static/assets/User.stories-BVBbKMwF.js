...
`,re=class extends J{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.userFollowClicked=X(this,"userFollowClicked",7),this.userTitle="User title",this.userCover=void 0,this.userCoverFallback=Y,this.followers=0,this.showStats=!0,this.userDescription=void 0}render(){return e(Z,{key:"951eb20f0146b27eb9e65de8c1e8fbcbf7113ff3"},e("div",{key:"c0983abfa424318d1a3100e5f38d125934c94d10",class:"user"},e("section",{key:"a68d1915ba5a12957b64ec45d02a52b8391d9f5d",class:"cover",style:{backgroundImage:this.userCover?`url(${this.userCover})`:`url(${this.userCoverFallback})`}}),e("section",{key:"d588a67d3264923d1a85c84d03bdf0049ad3d46c",class:"info"},e("div",{key:"2e674edce61b7c69fac0c85a9b09008c0fa6b19a",class:"title"},this.userTitle),this.showStats&&e("div",{key:"59ff51cfa2671d36f9834b4c58d6d1ddf64b7b48",class:"stats"},e("div",{key:"53cac4cb59e6f845abc8c5d731b82a58fcd57bb0",class:"followers"},e("div",{key:"e1e34b1b5d3fc8a80b6bff0ea7457aa24273fbff"},e("b",{key:"36a37d856cc4d87e9e322aed5b01d1ce3ff7bd85"},this.followers)," Followers"))),e("div",{key:"4c99a023ef0fc6251e66cdd9d6808ef69c1d361c",class:"description"},this.userDescription),e("div",{key:"71b5250913ad8d58a0a09ea5565f30420e8a2608",class:"actions"},e("ur-button",{key:"1afd5e3bafce9bd6f556d9dcb635173bd387107e",class:"follow",variant:"outlined",onClick:()=>this.userFollowClicked.emit()},"Follow")))))}static get style(){return ee}};G(re,[1,"ur-user",{userTitle:[1,"user-title"],userCover:[8,"user-cover"],userCoverFallback:[8,"user-cover-fallback"],followers:[2],showStats:[4,"show-stats"],userDescription:[8,"user-description"]}]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"UrUser",tagName:"ur-user",customElement:!0,members:[{kind:"field",name:"userTitle",type:"string",description:"",default:"'User title'"},{kind:"field",name:"userCover",type:"any",description:""},{kind:"field",name:"userCoverFallback",type:"any",description:"",default:"USER_COVER_FALLBACK"},{kind:"field",name:"followers",type:"number",description:"",default:"0"},{kind:"field",name:"showStats",type:"boolean",description:"",default:"true"},{kind:"field",name:"userDescription",type:"any",description:""}],events:[{kind:"event",name:"userFollowClicked",description:""}]}],exports:[{kind:"js",name:"UrUser",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}},{kind:"custom-element-definition",name:"ur-user",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}}]}]};q({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const se=({userTitle:u,userCover:W,followers:N,showStats:Q,userDescription:H,borderRadius:V="8px",width:j})=>K`
    <style>
        ur-user {
            --user-width: ${j};
...
}`,...(T=($=l.parameters)==null?void 0:$.docs)==null?void 0:T.source}}};const be=["Default","BrokenCover","NoStats","SmallDescription","BigDescription","SmallerWidth","BiggerWidth","BigDescriptionWithBiggerWidth","NoBorderRadius"];export{a as BigDescription,d as BigDescriptionWithBiggerWidth,c as BiggerWidth,o as BrokenCover,s as Default,l as NoBorderRadius,n as NoStats,t as SmallDescription,i as SmallerWidth,be as __namedExportsOrder,ge as default};
