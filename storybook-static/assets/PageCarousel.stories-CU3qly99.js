...
}`,...(L=(A=l.parameters)==null?void 0:A.docs)==null?void 0:L.source}}};var W,N,U;p.parameters={...p.parameters,docs:{...(W=p.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => PageCarousel(args),
  args: {
    pages: PAGES.map((page, index) => {
      if (index === 2) {
...
}`,...(U=(N=p.parameters)==null?void 0:N.docs)==null?void 0:U.source}}};const ce=["Default","TwoRowsGrid","SneakPeek","FullWithArrows","CustomSlide"];export{p as CustomSlide,a as Default,l as FullWithArrows,d as SneakPeek,o as TwoRowsGrid,ce as __namedExportsOrder,pe as default};
