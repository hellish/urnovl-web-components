...
`,ne={title:"Core/Buttons",render:i=>z(i),argTypes:{variant:{control:"select",options:["elevated","filled","tonal","outlined","text"]}}},e={render:()=>O()},t={render:()=>q()},r={args:{}},o={args:{disabled:!0}},n={args:{variant:"outlined"},argTypes:{variant:{control:"select",options:["elevated","filled","tonal","outlined","text"]}}},s={args:{icon:"search",endIcon:"arrow_forward"}},a={args:{icon:"search",endIcon:"arrow_forward",variant:"outlined",disabled:!1}};var m,p,f;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(A=(x=n.parameters)==null?void 0:x.docs)==null?void 0:A.source}}};var S,E,C;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    icon: 'search',
    endIcon: 'arrow_forward'
  }
}`,...(C=(E=s.parameters)==null?void 0:E.docs)==null?void 0:C.source}}};var U,W,$;a.parameters={...a.parameters,docs:{...(U=a.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    icon: 'search',
    endIcon: 'arrow_forward',
    variant: 'outlined',
...
}`,...($=(W=a.parameters)==null?void 0:W.docs)==null?void 0:$.source}}};const se=["ArrowLeft","ArrowRight","Basic","Disabled","WithVariant","WithIcons","Full"];export{e as ArrowLeft,t as ArrowRight,r as Basic,o as Disabled,a as Full,s as WithIcons,n as WithVariant,se as __namedExportsOrder,ne as default};
