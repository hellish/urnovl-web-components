import{l as c}from"./get-w4emotEH.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let f=new d;f.resolve();let l=!1;const o=new Map,w=(e,t)=>{l||(l=!0,c().addEventListener(n,a=>{a.detail.status==="ready"&&o.forEach(i=>{i.forEach(r=>r())})}));const s=o.get(e)||[];s.push(t),o.set(e,s)},L=e=>{o.delete(e)};export{w as a,L as o};
