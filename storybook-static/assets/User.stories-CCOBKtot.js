...
`,re=class extends J{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.userFollowClicked=X(this,"userFollowClicked",7),this.userTitle="User title",this.userCover=void 0,this.userCoverFallback=Y,this.followers=0,this.showStats=!0,this.userDescription=void 0}render(){return e(Z,{key:"1c9df5c40fa726baeaab1a313da77c4b9fed7568"},e("div",{key:"f4bf0d9d1371d4be7bde085e7873d3c29008a58e",class:"user"},e("section",{key:"d522644d3c627e3e1c185f051b561f119fef5587",class:"cover",style:{backgroundImage:this.userCover?`url(${this.userCover})`:`url(${this.userCoverFallback})`}}),e("section",{key:"289aaf5ecc7392269a6c8e08dd7ffec8d7195cf0",class:"info"},e("div",{key:"6f7fbc9810e68d7f407e69b0397a5a3e77f8cd0c",class:"title"},this.userTitle),this.showStats&&e("div",{key:"19e4b093e2d7c60183628da035e1f478f5e4e3c1",class:"stats"},e("div",{key:"b8d064277f9f81ea07cb814eef31af71dea90e74",class:"followers"},e("div",{key:"541ccd6c91ed8cad04ec12265c24c457efacfe0d"},e("b",{key:"55c22c7260d7deef2d78010a30858444ac68087a"},this.followers)," Followers"))),e("div",{key:"161fa23e9e19f8bab3fb7ad2706ac893467f1061",class:"description"},this.userDescription),e("div",{key:"e780b88d5ae86e95e555a7e143227dca3eebbd75",class:"actions"},e("ur-button",{key:"d909b16a20fec66a5cae9bbdac87f38d350c4923",class:"follow",variant:"outlined",onClick:()=>this.userFollowClicked.emit()},"Follow")))))}static get style(){return ee}};G(re,[1,"ur-user",{userTitle:[1,"user-title"],userCover:[8,"user-cover"],userCoverFallback:[8,"user-cover-fallback"],followers:[2],showStats:[4,"show-stats"],userDescription:[8,"user-description"]}]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"UrUser",tagName:"ur-user",customElement:!0,members:[{kind:"field",name:"userTitle",type:"string",description:"",default:"'User title'"},{kind:"field",name:"userCover",type:"any",description:""},{kind:"field",name:"userCoverFallback",type:"any",description:"",default:"USER_COVER_FALLBACK"},{kind:"field",name:"followers",type:"number",description:"",default:"0"},{kind:"field",name:"showStats",type:"boolean",description:"",default:"true"},{kind:"field",name:"userDescription",type:"any",description:""}],events:[{kind:"event",name:"userFollowClicked",description:""}]}],exports:[{kind:"js",name:"UrUser",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}},{kind:"custom-element-definition",name:"ur-user",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}}]}]};q({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const se=({userTitle:u,userCover:W,followers:N,showStats:Q,userDescription:H,borderRadius:V="8px",width:j})=>K`
    <style>
        ur-user {
            --user-width: ${j};
...
`,ve={title:"Urnovl/Business/User",render:u=>se(u)},s={args:r[0]},o={args:{...r[0],userCover:null}},n={args:r[1]},t={args:r[0]},a={args:r[2]},i={args:{...r[0],width:"250px"}},c={args:{...r[0],width:"650px"}},d={args:{...r[2],width:"650px"}},l={args:{...r[0],userCover:r[0].userCover,width:"100%",borderRadius:"0"}};var f,h,g;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: USERS[0]
...
}`,...(T=($=l.parameters)==null?void 0:$.docs)==null?void 0:T.source}}};const we=["Default","BrokenCover","NoStats","SmallDescription","BigDescription","SmallerWidth","BiggerWidth","BigDescriptionWithBiggerWidth","NoBorderRadius"];export{a as BigDescription,d as BigDescriptionWithBiggerWidth,c as BiggerWidth,o as BrokenCover,s as Default,l as NoBorderRadius,n as NoStats,t as SmallDescription,i as SmallerWidth,we as __namedExportsOrder,ve as default};
