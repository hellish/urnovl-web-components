...
`,se=class extends J{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.userFollowClicked=X(this,"userFollowClicked",7),this.userTitle="User title",this.userCover=void 0,this.userCoverFallback=Y,this.followers=0,this.showStats=!0,this.userDescription=void 0}render(){return e(Z,{key:"42e9c1f661e72824cbfa975c335d4ae29a69f33c"},e("div",{key:"b4b4c56810bd0bc5f8f037ee383d6fc936a6889b",class:"user"},e("section",{key:"b835f2e4fedbc87e56d90d601b8dd2a283384c20",class:"cover",style:{backgroundImage:this.userCover?`url(${this.userCover})`:`url(${this.userCoverFallback})`}}),e("section",{key:"72d68bd0a4f62ff515d1a7e18668140c06633766",class:"info"},e("div",{key:"dd9df904e721364cddd8adc4bc66955ace25cf0e",class:"title"},this.userTitle),this.showStats&&e("div",{key:"1432155923f101ad5224ed1f69e7a890c830b29b",class:"stats"},e("div",{key:"5ec93f06f10889466d38ac8d726d5c168ce58060",class:"followers"},e("div",{key:"0189efa0c034181b98019055a9a3295da97a5ad5"},e("b",{key:"f30171eeed772a4acbb0e2ed6f589f6c69972f3b"},this.followers)," Followers"))),e("div",{key:"9c1e56051881dba7c931c952d9feff399b47220e",class:"description"},this.userDescription),e("div",{key:"94c26374123f04853771a65070754263378524d0",class:"actions"},e("ur-button",{key:"ad4ac1127edde3b22b2c04ce566e0210d15f5529",class:"follow",variant:"outlined",onClick:()=>this.userFollowClicked.emit()},"Follow")))))}static get style(){return ee}};G(se,[1,"ur-user",{userTitle:[1,"user-title"],userCover:[8,"user-cover"],userCoverFallback:[8,"user-cover-fallback"],followers:[2],showStats:[4,"show-stats"],userDescription:[8,"user-description"]}]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"UrUser",tagName:"ur-user",customElement:!0,members:[{kind:"field",name:"userTitle",type:"string",description:"",default:"'User title'"},{kind:"field",name:"userCover",type:"any",description:""},{kind:"field",name:"userCoverFallback",type:"any",description:"",default:"USER_COVER_FALLBACK"},{kind:"field",name:"followers",type:"number",description:"",default:"0"},{kind:"field",name:"showStats",type:"boolean",description:"",default:"true"},{kind:"field",name:"userDescription",type:"any",description:""}],events:[{kind:"event",name:"userFollowClicked",description:""}]}],exports:[{kind:"js",name:"UrUser",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}},{kind:"custom-element-definition",name:"ur-user",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}}]}]};q({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const re=({userTitle:u,userCover:W,followers:N,showStats:Q,userDescription:H,borderRadius:V="8px",width:j})=>K`
    <style>
        ur-user {
            --user-width: ${j};
...
}`,...(T=($=l.parameters)==null?void 0:$.docs)==null?void 0:T.source}}};const fe=["Default","BrokenCover","NoStats","SmallDescription","BigDescription","SmallerWidth","BiggerWidth","BigDescriptionWithBiggerWidth","NoBorderRadius"];export{i as BigDescription,d as BigDescriptionWithBiggerWidth,c as BiggerWidth,o as BrokenCover,r as Default,l as NoBorderRadius,n as NoStats,t as SmallDescription,a as SmallerWidth,fe as __namedExportsOrder,me as default};
