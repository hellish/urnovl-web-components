import{x as g}from"./entry-preview-CxXhOGqP.js";import"./ur-linear-progress-CeRTQHz3.js";import"./index-DrFu-skq.js";import"./chunk-L4EGOTBX-BPj2F1fn.js";import"./index-Bdp-Mrn6.js";const d=s=>g` <ur-linear-progress max="${s.max}" value="${s.value}"></ur-linear-progress> `,D={title:"Core/Linear Progress",render:d,argTypes:{max:{control:"number",description:"The maximum value for the progress bar"},value:{control:"number",description:"The current value for the progress bar. If omitted, the progress bar will be indeterminate."}}},r={args:{max:1},render:()=>g` <ur-linear-progress max="1"></ur-linear-progress> `},e={args:{max:1,value:.5}},a={args:{max:100,value:100}};var o,t,n;r.parameters={...r.parameters,docs:{...(o=r.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    max: 1
  },
