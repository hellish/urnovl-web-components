...
`,re=class extends J{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.userFollowClicked=X(this,"userFollowClicked",7),this.userTitle="User title",this.userCover=void 0,this.userCoverFallback=Y,this.followers=0,this.showStats=!0,this.userDescription=void 0}render(){return e(Z,{key:"23e7c0d9496da761705f4a3d2e4d17c760f523cf"},e("div",{key:"50f04ffe3b677b31206f4cdc5187a4dcfc9bcef6",class:"user"},e("section",{key:"4bca819f02bd4f59a0ca143a2abd43f14e3f114c",class:"cover",style:{backgroundImage:this.userCover?`url(${this.userCover})`:`url(${this.userCoverFallback})`}}),e("section",{key:"e3a3a1189140ae67a3129d1dcdb2a73f0f56791a",class:"info"},e("div",{key:"66c4b60e3328e853da032695bb18e87f8a7c63e5",class:"title"},this.userTitle),this.showStats&&e("div",{key:"638b91e4170cd291feff586f3b134ecc6c67a08c",class:"stats"},e("div",{key:"8f45c21d62165fd8a7cc2b44acf83a4ea389fe20",class:"followers"},e("div",{key:"7cf2ecc09257e066520b7d12a24eea187428b385"},e("b",{key:"e56f505234bcc1ac9191160d2c279413e66dd25a"},this.followers)," Followers"))),e("div",{key:"e0d7faadd1cda18e2b68f7485658a8819769a7bd",class:"description"},this.userDescription),e("div",{key:"359fff20fff0a7667c1780edbf6119d2603db28e",class:"actions"},e("ur-button",{key:"e6816a888a5aaaee26180511e0d3865e15ef3c69",class:"follow",variant:"outlined",onClick:()=>this.userFollowClicked.emit()},"Follow")))))}static get style(){return ee}};G(re,[1,"ur-user",{userTitle:[1,"user-title"],userCover:[8,"user-cover"],userCoverFallback:[8,"user-cover-fallback"],followers:[2],showStats:[4,"show-stats"],userDescription:[8,"user-description"]}]);const m={schemaVersion:"1.0.0",modules:[{kind:"javascript-module",path:"",declarations:[{kind:"class",name:"UrUser",tagName:"ur-user",customElement:!0,members:[{kind:"field",name:"userTitle",type:"string",description:"",default:"'User title'"},{kind:"field",name:"userCover",type:"any",description:""},{kind:"field",name:"userCoverFallback",type:"any",description:"",default:"USER_COVER_FALLBACK"},{kind:"field",name:"followers",type:"number",description:"",default:"0"},{kind:"field",name:"showStats",type:"boolean",description:"",default:"true"},{kind:"field",name:"userDescription",type:"any",description:""}],events:[{kind:"event",name:"userFollowClicked",description:""}]}],exports:[{kind:"js",name:"UrUser",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}},{kind:"custom-element-definition",name:"ur-user",declaration:{name:"UrUser",module:"src/components/ur-user/ur-user.tsx"}}]}]};q({...p()||{},...m,modules:[...(p()||{}).modules||[],...m.modules]});const se=({userTitle:u,userCover:W,followers:N,showStats:Q,userDescription:H,borderRadius:V="8px",width:j})=>K`
    <style>
        ur-user {
            --user-width: ${j};
...
}`,...(T=($=d.parameters)==null?void 0:$.docs)==null?void 0:T.source}}};const be=["Default","BrokenCover","NoStats","SmallDescription","BigDescription","SmallerWidth","BiggerWidth","BigDescriptionWithBiggerWidth","NoBorderRadius"];export{a as BigDescription,l as BigDescriptionWithBiggerWidth,c as BiggerWidth,o as BrokenCover,s as Default,d as NoBorderRadius,n as NoStats,t as SmallDescription,i as SmallerWidth,be as __namedExportsOrder,ge as default};
