import{k as p}from"./entry-preview-BcHUnPw7.js";import"./ur-form-DJd2r9fR.js";import"./ur-text-field-D7edll3i.js";import"./ur-button-CAONFgYs.js";import"./index-DrFu-skq.js";import"./chunk-L4EGOTBX-2Jzo53v8.js";import"./index-DddAbXmr.js";import"./index-CEVypOhu.js";import"./class-map-D9WDFjdt.js";import"./get-CrYa75fC.js";import"./if-defined-CL77Dv0Z.js";import"./live-DfYOlrrc.js";import"./when-BxLAFfhK.js";import"./form-Cw4bjwWA.js";import"./default-value-DJmU7Trf.js";import"./watch-ByvFYHv8.js";import"./observeResize-CJw6rTQh.js";import"./uniqueId-Bqzl4fNd.js";import"./template-yncBVCyc.js";import"./svg-tag-DnJ0JIim.js";import"./index-DSnKAvJF.js";import"./index-B130AqrC.js";import"./button-base-CjWp8XDk.js";import"./anchor-CiGySFkk.js";import"./index-B-tAPXHM.js";import"./index-BeAidxnL.js";const S=({fields:i=[],buttons:$=[{label:"Submit",action:"submitForm",variant:"filled",disabled:!1},{label:"Reset",action:"resetForm",variant:"outlined",disabled:!1}]})=>{const s=`form-status-${Math.random().toString(36).substring(2,8)}`,l=`form-data-${Math.random().toString(36).substring(2,8)}`,m=`form-errors-${Math.random().toString(36).substring(2,8)}`;let a=!1;const E=()=>{const e=document.querySelector("ur-form"),t=document.getElementById(s),u=document.getElementById(l),c=document.getElementById(m);e.addEventListener("formDataChanged",r=>{console.log("Form data changed:",r.detail),u.textContent=JSON.stringify(r.detail,null,2)}),e.addEventListener("formValid",()=>{console.log("Form is valid!"),t.textContent="Form is valid! 🎉",t.style.color="green",a=!0,d()}),e.addEventListener("formInvalid",r=>{console.log("Form is invalid:",r.detail.errors),t.textContent=`Form is invalid: ${JSON.stringify(r.detail.errors)}`,t.style.color="red",a=!1,c.textContent=JSON.stringify(r.detail.errors,null,2),d()})},d=()=>{const e=document.querySelector('[data-action="submitForm"]');e&&(e.disabled=!a)},x=()=>{document.querySelector("ur-form").submitForm()},v=()=>{const e=document.querySelector("ur-form"),t=document.getElementById(s),u=document.getElementById(l),c=document.getElementById(m);e.resetForm(),t.textContent="Form has been reset.",t.style.color="blue",u.textContent="",c.textContent="",a=!1,d()};return setTimeout(E,0),p`
        <ur-form>
            ${i.map(e=>p`
                    <ur-text-field
                        label=${e.label}
